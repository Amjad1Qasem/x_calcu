...
abstract class AppThemes {
  static ThemeData get light => _theme(
        ...
        secondaryColor: ColorManager.yellow,
        ...
        // primaryContainer: ColorManager.softblack
      );
  ...
  static ThemeData get dark => _theme(
      ...
      surfaceColor: ColorManager.primaryText,
      primaryText: ColorManager.primaryText,
      disableGrey: ColorManager.disableGrey,
      disableGreyButton: ColorManager.disableGreyButton,
      selectedColor: ColorManager.green,
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headlineMedium: TextStyle(
            color: textColor, fontSize: 22.sp, fontWeight: FontWeight.w600),
...
extension Utils on BuildContext {
  ...
  TextStyle get blueClickbleText => Theme.of(this).textTheme.headlineSmall!;

  TextStyle get greyText => Theme.of(this).textTheme.titleSmall!;

  TextStyle get hintText => Theme.of(this).textTheme.titleMedium!;

  TextStyle get buttonText => Theme.of(this).textTheme.labelLarge!;

  TextStyle get greyTextMedium => isLightTheme
      ? Theme.of(this).textTheme.labelMedium!
      : Theme.of(this)
          .textTheme
          .labelMedium!
          .copyWith(color: const Color(0xffA4A6AB));
  ...
  /// saleh text style
  ///
  TextStyle get smallBodyGray => isLightTheme
      ? Theme.of(this).textTheme.displaySmall!
      : Theme.of(this)
          .textTheme
          .displaySmall!
          .copyWith(color: const Color(0xffB0B3B8));
  ...
  Color get secondaryBlue => Theme.of(this).colorScheme.onPrimaryFixed;
  ...
  Color get backgroundColor =>
      isLightTheme ? Colors.white : ColorManager.pureBlack;
  ...
  Color get shadowColor => isLightTheme
  ...
  Color get appBarIconsColor =>
      isLightTheme ? ColorManager.blue : ColorManager.white;
