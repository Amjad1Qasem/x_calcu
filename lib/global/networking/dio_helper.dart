...
class DioHelper {
    ...
    try {
      ...
      if (response.data != null) {
        ...
        return Result.failure(
          ServerError(response.data["message"] ?? "unknown_server_error".tr()),
        );
      }
  ...
  static Failure getDioError(DioException e) {
    ...
    switch (e.type) {
      ...
      case DioExceptionType.sendTimeout:
        return ServerError("request_send_timeout".tr());

      case DioExceptionType.receiveTimeout:
        return ServerError("request_receive_timeout".tr());
  ...
  static Map<String, dynamic>? _extractValidationErrors(dynamic data) {
    try {
      ...
      printError("error_extracting_validation_errors".tr() + e.toString());
    }
    return null;
  }
}
