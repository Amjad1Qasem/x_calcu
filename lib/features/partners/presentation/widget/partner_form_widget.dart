...
class PartnerFormWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (cubitType == CubitType.edit && cubit != null) {
      return _buildEditForm(context, cubit as EditPartnerCubit);
    } else {
  ...
  Widget _buildEditForm(BuildContext context, EditPartnerCubit cubit) {
    return BlocBuilder<EditPartnerCubit, EditPartnerState>(
      bloc: cubit,
      builder: (context, state) {
        return Form(
          key: cubit.editPartnerFormKey,
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // Show validation errors summary if there are any
