...
List<PersistentBottomNavBarItem> _navBarsItems({
  ...
  return [
    ...
    PersistentBottomNavBarItem(
      contentPadding: 0,
      icon: Icon(Icons.add, size: 38.sp, color: Colors.white),
      activeColorPrimary: Utils(context).secondary,
      inactiveColorPrimary: Utils(context).secondary,
    ),
    PersistentBottomNavBarItem(
      icon: _buildIcon(
        context,
...
// تعديل MainLayout لقبول initialIndex والعمل به بشكل صحيح
...
//           style: TextStyle(
//             fontSize: 12.sp,
//             color: isActive ? Utils(context).primary : Utils(context).black,
//             fontWeight: FontWeight.bold,
//           ),
//         ),
//       ),
